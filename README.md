...
<li> Helpful Link to Downloads: https://drive.google.com/drive/u/0/folders/1APMfNyfNzcxZC6EzdaNfdZsUwxWYChf6 </li>
...
1.) The first thing you are going to do is create a *virtual machine by going to https://portal.azure.com/. Setup your virtual machine with Windows 10 Pro, version 22H2. *Note, you will want to create a virtual machine with at least 2 vcpus and 16 gbs of memory.

2.) Once you have created your virtual machine, you will want to connect to it by using the public ip address that the vm is setup with. You will connect using the remote desktop connection app.
...
Last step is to clean up. We will want to delete the setup folder in our system.
<p>
...
<p>
<img src="https://imgur.com/FWfiOtp.png" height="65%" width="65%" alt="Disk Sanitization Steps"/>
<p>
This is the conclusion of the setup lab!
